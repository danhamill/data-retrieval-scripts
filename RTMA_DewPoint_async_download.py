...
if __name__ == '__main__':
    ...
    start = datetime(2016, 10, 1, 0, 0)
    end = datetime(2017, 10, 1, 0, 0)
    hour = timedelta(hours=1)
    destination = r"C:\Users\RDCRLDDH\Desktop\RTMA_DEW_POINT\WY17"
    ...
    opath = []
    while date < end:
        url = "http://mtarchive.geol.iastate.edu/{:04d}/{:02d}/{:02d}/grib2/ncep/RTMA/{:04d}{:02d}{:02d}{:02d}00_DWPK.grib2".format(
