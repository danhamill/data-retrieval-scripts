...
if __name__ == '__main__':
    ...
    end = datetime(2020, 9, 1, 0, 0)
    hour = timedelta(hours=1)
    destination = r"C:\workspace\ririe\HMS\data\Wind\2020"
    ...
    while date < end:
        url = "http://mtarchive.geol.iastate.edu/{:04d}/{:02d}/{:02d}/grib2/ncep/RTMA/{:04d}{:02d}{:02d}{:02d}00_UGRD.grib2".format(
        ...
        url = "http://mtarchive.geol.iastate.edu/{:04d}/{:02d}/{:02d}/grib2/ncep/RTMA/{:04d}{:02d}{:02d}{:02d}00_VGRD.grib2".format(
            date.year, date.month, date.day, date.year, date.month, date.day, date.hour)
